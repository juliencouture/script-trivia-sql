...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 03 Juin 2015 à 16:27
...
(1, 1, 'couture', 'julien', 'juliencouture@sts-sio-caen.info', 'jcouture', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 1),
(2, 1, 'portois', 'theo', 'theoportois@sts-sio-caen.info', 'tportois', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 2),
(3, 1, 'tostain', 'guillaume', 'guillaumetostain@sts-sio-caen.info', 'gtostain', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 2),
(4, 2, 'nom1', 'prenom1', 'juliencouture@sts-sio-caen.info', 'Adversaire1', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 3),
(5, 2, 'nom2', 'prenom2', 'juliencouture@sts-sio-caen.info', 'Adversaire2', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 3),
(6, 3, 'nom3', 'prenom3', 'juliencouture@sts-sio-caen.info', 'Adversaire3', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 3),
(7, 3, 'nom4', 'prenom4', 'juliencouture@sts-sio-caen.info', 'Adversaire4', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 3);
...
--
ALTER TABLE `serie`
 ADD KEY `joueur` (`idjoueur`,`idpartie`), ADD KEY `joueur_2` (`idjoueur`), ADD KEY `partie` (`idpartie`), ADD KEY `nombre` (`nombre`);
...
--
ALTER TABLE `serie`
ADD CONSTRAINT `serie_ibfk_1` FOREIGN KEY (`idjoueur`) REFERENCES `joueur` (`id`),
ADD CONSTRAINT `serie_ibfk_2` FOREIGN KEY (`idpartie`) REFERENCES `partie` (`id`);
